...
La seguente funzione associa ad ogni elemento di A uno ed un solo elemento di B  
$$f:A\rightarrow B$$  
In alternativa  
$$x\in A \mbox{ e } f(x)\in B$$  

Se l'insieme A è discreto allora la funzione viene detta successione.  
Si definisce indice la variabile $$n$$.  
$$n \in A \equiv \Im$$  
